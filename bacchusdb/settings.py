# Django settings for bacchusdb project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'BacchusDB',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'y+n^9iu75-)6c(loqoh!nqa%l!m@gmb2x9t0u7!nb#)ny48!b+'
...
ROOT_URLCONF = 'bacchusdb.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bacchusdb.wsgi.application'
